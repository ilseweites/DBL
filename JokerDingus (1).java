...
class JokerDingus extends Dingus {
    ...
    void draw(Graphics g) {
        ...
        //Creates the right traingle on the crown of the joker
        ...
        //Creates the parralelegram on the bottom of the joker
        g.setColor(color);//Creates random color
        if (filled)
        ...
        // g.setColor(color);
        // if (filled)
        //     g.fillArc(x-radius/2, y-radius/2, radius/4, radius/4, 0, 360);
        // else
        //     g.drawArc(x-radius/2, y-radius/2, radius/4, radius/4, 0, 360);

        // g.setColor(color);
        // if (filled)
        //     g.fillArc(x+radius, y+radius, radius/4, radius/4, 0, 360);
        // else
        //     g.drawArc(x+radius, y+radius, radius/4, radius/4, 0, 360);

        // g.setColor(color);
        // if (filled)
        //     g.fillArc(x, y, radius/4, radius/4, 0, 360);
        // else
        //     g.drawArc(x, y, radius/4, radius/4, 0, 360);
